...
public class BaseLogApp {
    public static void main(String[] args) throws Exception {
        ...
        //创建KafkaSource
        FlinkKafkaConsumer<String> kafkaSource = MyKafkaUtilTest01.getKafkaSource(topic, groupId);
        ...
        pageDS.addSink(MyKafkaUtilTest01.getKafkaSink("dwd_page_log"));
        startDS.addSink(MyKafkaUtilTest01.getKafkaSink("dwd_start_log"));
        displayDS.addSink(MyKafkaUtilTest01.getKafkaSink("dwd_display_log"));
